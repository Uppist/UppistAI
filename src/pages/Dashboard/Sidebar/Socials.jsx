...
export default function Socials({ setIsSocials }) {
  return (
    <div className='flex absolute z-50 bg-white shadow-2xl left-10 w-40 flex-col rounded-lg gap-y-1.5 p-4'>
      ...
      <div className='flex flex-col gap-y-5 items-baseline mt-2'>
        ...
        >
          ...
          <span className='text-sm font-normal text-grey'>Whatsapp</span>
        </NavLink>
        ...
        >
          ...
          <span className='text-sm font-normal text-grey'>Social Media</span>
        </NavLink>
