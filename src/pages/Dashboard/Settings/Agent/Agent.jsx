...
import CreateAgentProvider from "../../../../contexts/Settings/CreateAgentProvider";
export default function Agent() {
  const [agentClick, setAgentClick] = useState(false);
  function Create() {
    setAgentClick(!agentClick);
  }
  return (
    <>
      <CreateAgentProvider>
        <div className='flex flex-col gap-y-5'>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex flex-col gap-y-0.5'>
              <h3 className='text-black font-semibold text-base'>AI Agents</h3>
              <span className='text-xs font-normal text-grey'>
                Configure agents and assign them to channels
              </span>
            </div>
            ...
            {agentClick && <CreateAgent onClose={() => setAgentClick(false)} />}
          </div>
          <AgentContainer />
        </div>
      </CreateAgentProvider>
