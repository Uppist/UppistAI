    ...
    <>
      <div className="mt-10 flex flex-col gap-y-9.5">
        <div className="flex items-center justify-between">
          ...
          {/*Create agent button */}
          <button
            className="flex items-center gap-x-2 rounded-lg border border-light-grey text-black hover:bg-bg hover:border-none hover:text-white text-sm font-semibold py-2.5 px-3 cursor-pointer"
            onClick={Create}
          >
            <svg
