    ...
    <div className='h-80 overflow-scroll no-scrollbar'>
      <div className='border-t border-t-light-grey pt-10 flex flex-col gap-y-5'>
        <div className='flex flex-col gap-y-2.5'>
          <h3 className='text-base font-semibold text-black'>Prompt Query</h3>
        ...
        <div className='flex flex-col gap-y-2.5'>
          <h3 className='text-base font-semibold text-black'>AI Response</h3>
          <p className='text-sm font-normal text-grey leading-6'>
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
            ever since the 1500s, when an unknown printer took a galley of type
