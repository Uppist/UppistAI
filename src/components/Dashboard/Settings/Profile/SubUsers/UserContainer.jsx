...
export default function UserContainer() {
  ...
  const list = [
    {
      initials: initials("Daniel Smith"),
      name: "Daniel Smith",
        ...
        {list.map((item, index) => (
          ...
          >
            <div className='flex items-center gap-x-2'>
              <div className='w-8 h-8 rounded-full bg-light-grey text-[10px] font-bold text-black flex items-center justify-center'>
                {item.initials}
              </div>
              <span className='text2'>{item.name}</span>
            </div>
            <span className='text2'>{item.email}</span>
            <span className='text2 border px-3 py-1.5 rounded-lg w-fit border-light-grey'>
              {item.role}
            </span>
            {/*Menu */}
            <div className='w-full relative flex justify-end items-center'>
              ...
              {openSvg === index && (
                <div className='absolute flex flex-col bg-white top-5 z-10 right-0 shadow-lg rounded-lg p-3.5 gap-y-2.5 '>
                  <span className='flex items-center gap-x-1.5  text-sm font-medium text-light-black p-2 cursor-pointer hover:bg-slate-100'>
                    <svg
                      width='20'
                      height='20'
                      viewBox='0 0 20 20'
